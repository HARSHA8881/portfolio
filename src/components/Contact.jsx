          ...
          <div className="contact-main">
            <div className="contact-header">
              ...
              <p className="contact-description">
                ...
                or just want to say hi, feel free to reach out! I'll try my best to get back to you.
              </p>
              <p className="contact-subtitle">
                You can reach me through any of the following ways:
              </p>
            </div>
            <div className="contact-methods">
              <a 
                href="mailto:harshagonela505@gmail.com" 
              ...
              >
                ...
                <div className="method-content">
                  <h4>Email</h4>
                  <p>harshagonela505@gmail.com</p>
                </div>
              </a>
              <a 
                href="https://github.com/HARSHA8881" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/harsha-gonela-579819323/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a href="https://www.instagram.com/harsha.gonela/" 
